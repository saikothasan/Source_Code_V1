...
class PathaSaleDeliveryService
{
    /**
     * @throws \Throwable
     */
    public static function statusUpdate(Request $request)
    {
        ...
        if ($request->order_status == 'Delivered') {
            ...
            return ['message' => $consignment_id . ' Order status change to delivered'];
            ...
            $sale_return->user_id = $sale->user_id;
            ...
            return ['message' => $consignment_id . ' Order status change to returned'];
        } else if ($request->order_status == "Pickup_Cancelled") {
            DB::beginTransaction();
            ...
            DB::commit();
            return ['message' => $consignment_id . ' Order status change to cancelled'];
        }
    }
}
