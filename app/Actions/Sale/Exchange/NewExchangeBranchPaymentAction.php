...
class NewExchangeBranchPaymentAction
{
    public function execute($payment, $amount, $sale,$sale_exchange): void
    {
        ...
        if ($payment['payment_method']['text'] == 'Cash') {
            ...
            $cash_history->sale_exchange_id = $sale_exchange->id;
            $cash_history->save();
        }
        ...
        $branch_payment_history->sale_exchange_id = $sale_exchange->id;
