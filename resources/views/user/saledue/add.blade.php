...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{route('sale.index')}}"><i class="fa fa-shopping-cart"></i> Sales</a></li>
            <li><a href="{{route('sales-due.index')}}"><i class="fa fa-money"></i> Sale dues Collection</a></li>
                ...
                <div class="box box-6a8d9d box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                        	<a href="{{route('sales-due.index')}}" class="btn btn-sm bg-purple"><i class="fa fa-list"></i> Sale due collections list</a>
                        </div>		
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    	...
                    	<form action="{{route('sales-due.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    		@csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="paid" placeholder="paid" class="form-control" required="" type="number" onkeyup="calculateDue()" id="paid" autocomplete="off" value="0" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2">Cash</label>
                                <div class="col-sm-9">
                                    <input name="cash" placeholder="Cash" class="form-control" required="" type="number" onkeyup="calculateDue()" id="cash" autocomplete="off" value="0">
                                </div>
                            </div>
                            <div class="form-group">
...
@section('footerSection')
    ...
    <script>
        ...
        function calculateDue() {
            ...
            var due = parseInt(total_due) - parseInt(paid) - parseInt(cash);
            $('#due').val(due);
