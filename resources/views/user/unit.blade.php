...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{route('unit.index')}}"><i class="fa fa-group"></i> Unit</a></li>
        </ol>
    </section>
    <div class="content">
        <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	...
                                    	<form action="{{route('unit.destroy',$unit->id)}}" method="post" style="display: none;" id="delete-form-{{ $unit->id}}">
                                            @csrf
                                            {{method_field('DELETE')}}
                                        </form>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('unit.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="edit-modal" role="dialog">
  ...
  <script type="text/javascript">
    $('#edit-modal').on("show.bs.modal", function(event){
        ...
        var action = '{{URL::to('user/unit/update')}}';
