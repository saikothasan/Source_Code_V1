...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('sale.show',$sale_detail->sale_id)}}"><i class="fa fa-eye"></i> Sale details</a></li>
                ...
                <div class="box box-purple box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                        	<a href="{{URL::to('user/sale-return')}}" class="btn btn-sm bg-green"><i class="fa fa-list"></i> Sale return list</a>
                        </div>		
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    	...
                    	<form action="{{route('sale-return.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    		@csrf
