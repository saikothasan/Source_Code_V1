...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('purchase.show',$purchase_detail->purchase_id)}}"><i class="fa fa-eye"></i> Purchase details</a></li>
                ...
                <div class="box box-purple box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                        	<a href="{{URL::to('user/purchase-return')}}" class="btn btn-sm bg-green"><i class="fa fa-list"></i> Purchase return list</a>
                        </div>		
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    	...
                    	<form action="{{route('purchase-return.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    		@csrf
