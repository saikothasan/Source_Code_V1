...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{route('departments')}}"><i class="fa fa-group"></i> Department</a></li>
        </ol>
    </section>
    <div class="content">
        <div class="row">
                ...
                <div class="box box-teal box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> New department</a>
                        </div>		
                    </div>
                    <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	...
                                    	<a class="btn btn-sm bg-teal" href="#" data-toggle="modal" data-target="#edit-modal" data-id="{{$department->id}}" data-name="{{$department->name}}"><span class="glyphicon glyphicon-edit"></span></a>
                                        ...
                                        <a class="btn btn-sm bg-red" href="" onclick="if(confirm('Are You Sure To Delete?')){
                                            ...
                                            getElementById('delete-form-{{ $department->id}}').submit();
                                            }else{
                                            event.preventDefault();
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('departments.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="edit-modal" role="dialog">
  ...
  <script type="text/javascript">
    $('#edit-modal').on("show.bs.modal", function(event){
        ...
        var action = '{{URL::to('admin/departments/update')}}';
