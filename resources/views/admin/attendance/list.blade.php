            ...
            <div class="col-md-12">
                ...
                <div class="box box-teal box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{translate('Attendance')}} {{translate('List')}}</h3>
                        <div class="box-tools pull-right">
                            <a href="{{route('attendance.create')}}" class="btn btn-sm bg-green"><i class="fa fa-plus"></i> {{translate('New')}} {{translate('Attendance')}}</a>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                    	...
                    	<form action="{{route('attendance')}}" method="GET" class="form-horizontal" enctype="multipart/form-data">
                    		@csrf
                            <div class="col-md-3">
