                ...
                <div class="row">
                    <div class="col-md-12 row">
                        <div class="col-md-12 text-center">
                            <h1><strong>{{translate('Customer')}} {{translate('Update')}}</strong></h1>
                ...
                <div class="text-center row">
                    ...
                    <div class="col-md-8">
                        <form role="form" method="POST" action="{{ route('customers.update', $customer->id) }}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <input type="text" name="phone" class="form-control rounded"
                                        value="{{ $customer->phone }}" placeholder="{{translate('Phone')}} {{translate('Number')}}">
                                    @error('phone')
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="district_id" class="form-control rounded"
                                        placeholder="{{translate('District')}}" value="{{ $customer->district_id }}">
                                    @error('district_id')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="zip_code" class="form-control rounded"
                                        placeholder="{{translate('Zip')}} {{translate('Code')}}" value="{{ $customer->zip_code }}">
                                    @error('zip_code')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <input type="text" name="address" class="form-control rounded"
                                        value="{{ $customer->address }}" placeholder="{{translate('Address')}}">
                                    @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <input type="date" name="date_of_birth" class="form-control rounded"
                                        value="{{ $customer->date_of_birth }}" placeholder="{{translate('Date Of Birth')}}">
                                    @error('date_of_birth')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <input type="text" name="facebook_id" value="{{ $customer->facebook_id }}"
                                ...
                                <div class="form-group col-md-12 image">
                                    @if ($customer->photo)
                                        <img src="{{ asset($customer->photo) }}"
                                            onerror="this.src='{{ asset('ecommerce/error-img.jpg') }}'" alt=""
                                            id="customer_photo">
                                    @else
                                        <img src="{{ asset('images/blank.jpg') }}" alt="" id="customer_photo">
                                    @endif
                                    <div class="col-sm-12">
